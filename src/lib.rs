...
#[derive(Debug)]
pub struct ArbitrageBotProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ArbitrageBotProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ArbitrageBot processing");
    
    let mut processor = ArbitrageBotProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ArbitrageBotProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ArbitrageBotProcessor::new(false);
